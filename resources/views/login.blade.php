            ...
            <div class="card mb-0">
              <div class="card-body">
                ...
                <form name="login" action="{{ route('loginaction') }}" method="post">
                  ...
                  <a href="{{ route('showregister') }}" class="btn btn-primary w-100 py-8 fs-4 mb-4 rounded-2">Sign Up</a>
                  <a href="{{ route('showforgot') }}" class="w-100 py-8 fs-4 mb-4 rounded-2 text-center d-block">Click here if you forgot your password.</a>
                </form>
              </div>
            </div>
          </div>
